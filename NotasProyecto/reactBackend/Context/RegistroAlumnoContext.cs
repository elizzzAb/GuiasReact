...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=LAPTOP-GK1DJVHC\\SQLEXPRESS; Initial Catalog=registroAlumno;User ID=Sonia;Password = 1234; Encrypt=False");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Alumno>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__alumno__3213E83FD0E38083");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__asignatu__3213E83F5162E9F1");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__califica__3213E83FED805414");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__matricul__3213E83F43A123A2");
        ...
        {
            entity.HasKey(e => e.Usuario).HasName("PK__profesor__9AFF8FC7A2F17E34");
